...
which would be the $\N\to\infty$ limit of \eref{g_est}. Instead it is the limit of the a diverging superverse
$\S\to\infty$. The superverse consists of $\S$ samples of $\N$ trajectories each.
\be
