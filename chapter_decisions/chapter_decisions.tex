...
Next, in \secref{Decisions_in_a_deterministic}, we will explore a setting where everything is known. 
In such a perfectly deterministic world, we will see that our
axiom leads to what's called ``discounting,'' a well-known behaviour of people facing inter-temporal choices.

In the next step, in \secref{Decisions_in_an} we will introduce noise -- randomness, ignorance, fluctuations. In that setting, 
...
\begin{picture}(200,80)(0,0)
 \put(-75,0){\includegraphics[width=.45\textwidth]{./chapter_decisions/figs/exp_disc_2.pdf}}
 \put(120,0){\includegraphics[width=.45\textwidth, angle=0]{./chapter_decisions/figs/exp_disc_1.pdf}}
 \put(-35,80){A}
 \put(155,80){B}
\end{picture}
...
\centering
\begin{picture}(200,80)(0,0)
 \put(-80,0){\includegraphics[width=.33\textwidth]{./chapter_decisions/figs/disc_1.pdf}}
 \put(40,0){\includegraphics[width=.33\textwidth, angle=0]{./chapter_decisions/figs/disc_2.pdf}}
 \put(160,0){\includegraphics[width=.33\textwidth, angle=0]{./chapter_decisions/figs/disc_3.pdf}}
\put(-60,60){A}
\put(60,60){B}
\put(180,60){C}
\end{picture}
