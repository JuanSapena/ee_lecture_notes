...
What value would we expect the equity premium to take in a real market. Substituting \eref{lopt} into \eref{hypothesis} yields $(\sigmam)^2 = \muem$ as an attractor. It follows from \eref{epdef} that the equity premium is attracted to
\be
\pim = \frac{\muem}{2}.
\elabel{epval}
\ee
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Tests of stochastic market efficiency\seclabel{tests}}
