...
#ax1.fill_betweenx([.01,100],1-2*parameters.loc['lopt_error','BTC'], 1-2*parameters.loc['lopt_error','DAX'],color=(1,1,0,0.2))
ax1.fill_betweenx([.01,100],1-2*parameters.loc['lopt_error','STR'], 1+2*parameters.loc['lopt_error','STR'],color=(0,0,1,0.2))
...
#ax.legend_.remove()
plt.savefig("../all_final_equity_2.pdf", bbox_inches='tight')
plt.show()
