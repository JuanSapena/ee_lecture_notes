...
input_dir_1="./../../../../Leverage_Efficiency/data/"
input_dir="./../../../../../../Dropbox/LML_research/ee_data/sme/"
...
ax1.fill_betweenx([.01,100],1-2*parameters.loc['lopt_error','DAX'], 1+2*parameters.loc['lopt_error','DAX'],color=(1,1,0,0.2))
...
#ax.legend_.remove()
plt.savefig("../all_final_equity_4.pdf", bbox_inches='tight')
plt.show()
