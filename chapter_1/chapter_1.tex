...
\be
\Abar_{\Dt}=\frac{1}{\T\dt}\sum_{\gtau=1}^{\T}\A(t+\gtau \dt).
\elabel{t_ave_f_disc}
\ee
...
to find the monotonic function of $\x$ whose additive changes inherit the stationarity of the ink in \eref{law}.
