...
\item[\bf \FED]
\item[\bf \SP]
The \SP does not include dividends. This understates the performance of its constituents; but we will compare it to 10-year maturity US Treasury Bills, whereof we only take into account the yield, disregarding changes in price.
\item[\bf \BRK]
