...
\be
\frac{\frac{1}{2}[\gv(\$220)+\gv(\$190)]-\gv(\$200)}{\D\t}>\frac{\frac{1}{2}[\gv(\$300)+\gv(\$130)]-\gv(\$200)}{\D\t}.
\ee
To check when this inequality is satisfied, we subtract the \RHS and simplify, to arrive at
the condition
\be
[\gv(\$220)+\gv(\$190)]-[\gv(\$300)+\gv(\$130)]> 0 \elabel{magnitude}.
\ee
...
maximise the rate of change of the expectation values of their wealths, according to \eref{EW_criterion}:
