...
unequivocally: no one wanted to wager more than a few dollars. This 
...
be designed that has discriminating power between the two sides of the map? If we mess with the
conditions that allow the mapping, so that the two theories are no longer equivalent, which theory
