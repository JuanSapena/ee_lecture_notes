...
legend('Expectation value','N=1','N=100','N=10,000','N=1,000,000','location','northWest');
axis([0 52 0 max(x(1:52,2))+1]);
xlabel('t');
ylabel('<x(t)>_N');
set(gca,'LooseInset',get(gca,'TightInset'))
saveas(gca,'./../figs/cf_exp_lin.pdf');
...
set(gca, 'YScale', 'log')
legend('Expectation value','N=1','N=100','N=10,000','N=1,000,000','location','northWest');
axis([0 52 0.9*min([x(1:52,2);x100(1:52,2);x10000(1:52,2);x1000000(1:52,2)]) max([x(1:52,2);x100(1:52,2);x10000(1:52,2);x1000000(1:52,2)])+1 ]);
xlabel('t');
ylabel('<x(t)>_N');
set(gca,'LooseInset',get(gca,'TightInset'))
saveas(gca,'./../figs/cf_exp_log.pdf');
