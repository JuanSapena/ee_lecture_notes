...
Forget, for the moment, what probabilities might resemble in a real experiment. In purely mathematical terms, they are just real numbers associated with outcomes. The probability distribution has two constraints:
\bi
...
When the set of outcomes is discrete, say $\{\z_\gj\}$ for $\gj=1 \dots M$, we assign a probability, $p_j$, to each outcome, $z_j$, such that
\be
